...
2. Add a new category method in the native filtering path, [src/talos/native_run_filtering.py](https://github.com/populationgenomics/talos/blob/main/src/talos/native_run_filtering.py).
...
3. Annotate the data using your new method in the same native filtering flow.
4. Add your new category to the retention logic in that native filtering flow so reportable variants are kept.
